...
def main_cli():
    ...
    parser.add_argument('--valid_run', type=argparse.FileType('rt'), default="data/cedr/test.tsv", nargs='+')
    parser.add_argument('--test_run', type=argparse.FileType('rt'), default="data/cedr/test.tsv")
    ...
    for file in args.valid_run:
        valid_run = data.read_run_dict(file)
        print(valid_run)
